export const Footer = () => `
  <footer class="bg-white/30 dark:bg-black/30 backdrop-blur-xl border-t border-white/40 dark:border-white/10 py-10 mt-auto relative z-10 transition-colors duration-300">
    <div class="max-w-6xl mx-auto px-4 text-center">
      
      <h3 class="text-2xl font-bold text-slate-900 dark:text-white mb-4">Hablemos.</h3>
      <p class="text-slate-600 dark:text-gray-400 mb-6 font-medium">Diseñado y construido con precisión.</p>
      ...
      <p class="text-xs text-slate-500 dark:text-gray-600 font-medium">
        © 2026 Javier Grossi. <span class="text-primary font-bold">Vite + Tailwind</span>
      </p>
    </div>
  </footer>
`;